    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="chongwuOrderUuidNumber">
                       <el-input v-model="ruleForm.chongwuOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.chongwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="chongwuOrderUuidNumber">
                           <el-input v-model="ruleForm.chongwuOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="领养类型" prop="chongwuOrderTypes">
                        <el-select v-model="ruleForm.chongwuOrderTypes" :disabled="ro.chongwuOrderTypes" placeholder="请选择领养类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="领养类型" prop="chongwuOrderValue">
                        <el-input v-model="ruleForm.chongwuOrderValue"
                            placeholder="领养类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   chongwuOrderTypes: [
                              { required: true, message: '领养类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
